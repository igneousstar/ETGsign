...
class vertColorSel extends UIobject{
  /**
  * name of the Slider
  */
  private String name;
  ...
  */
  ...
  public vertColorSel(String name, int centerX, int centerY, int sliderLength, int sliderWidth){
  ...
  */
  void drawUI(){
    ...
    for (float j = 0; j < sliderWidth; j++) {
      stroke(map(i, 0, sliderLength, 0, 255), 255, 255);
